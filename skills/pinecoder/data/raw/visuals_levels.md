...
[Levels](/pine-script-docs/visuals/plots/#levels) section of the
page on
...
[Pine Script®](https://tradingview.com/pine-script-docs)Copied`//@version=6indicator("TSI")myTSI = 100 * ta.tsi(close, 25, 13)hline( 50, "+50",  color.lime)hline( 25, "+25",  color.green)hline(  0, "Zero", color.gray, linestyle = hline.style_dotted)hline(-25, "-25",  color.maroon)hline(-50, "-50",  color.red)plot(myTSI)`

![image](/pine-script-docs/_astro/Levels-HlineLevels-01.DkWkzgaN_R6tzp.webp)

![image](/pine-script-docs/_astro/Levels-HlineLevels-02.rezExM6T_1CI5EH.webp)
...
the 25 level.
        ...
        [Previous       Fills](/pine-script-docs/visuals/fills)  [Next   Lines and boxes](/pine-script-docs/visuals/lines-and-boxes)