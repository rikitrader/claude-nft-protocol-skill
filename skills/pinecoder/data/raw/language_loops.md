...
[Pine Script®](https://tradingview.com/pine-script-docs)Copied`//@version=6indicator("Simple `for` loop demo")if barstate.islastconfirmedhistory    // Define a `for` loop that iterates from `i == 0` to `i == 10` by 1 (11 total iterations).    for i = 0 to 10        // Draw a new label `i` bars ahead of the current bar.          label.new(bar_index + i, 0, str.tostring(i), textcolor = color.white, size = size.large)`
...
[Pine Script®](https://tradingview.com/pine-script-docs)Copied`int lastIndex = array.size(myArray) - 1for i = 0 to lastIndex   element = array.get(i)`
...
[Pine Script®](https://tradingview.com/pine-script-docs)Copied`for index = 0 to (array.size(myArray) == 0 ? na : array.size(myArray) - 1)    element = array.get(myArray, index)`
...
[Pine Script®](https://tradingview.com/pine-script-docs)Copied`for element in myArray`
...
[Pine Script®](https://tradingview.com/pine-script-docs)Copied`for [index, element] in myArray`
...
[Pine Script®](https://tradingview.com/pine-script-docs)Copied`for rowIndex = 0 to (myMatrix.rows() == 0 ? na : myMatrix.rows() - 1)    rowArray = myMatrix.row(rowIndex)`
...
[Pine Script®](https://tradingview.com/pine-script-docs)Copied`for rowArray in myMatrix`
...
[Pine Script®](https://tradingview.com/pine-script-docs)Copied`for [rowIndex, rowArray] in myMatrix`
...
[Pine Script®](https://tradingview.com/pine-script-docs)Copied`for rowIndex = 0 to (myMatrix.rows() == 0 ? na : myMatrix.rows() - 1)    for columnIndex = 0 to myMatrix.columns() - 1        element = myMatrix.get(rowIndex, columnIndex)`
...
[Pine Script®](https://tradingview.com/pine-script-docs)Copied`for rowArray in myMatrix    for element in rowArray`
...
[Pine Script®](https://tradingview.com/pine-script-docs)Copied`for key in myMap.keys()    value = myMap.get(key)`
...
[Pine Script®](https://tradingview.com/pine-script-docs)Copied`for [key, value] in myMap`
...
- This script uses [both forms](/pine-script-docs/language/loops/#forin-loops) of the [for…in](https://www.tradingview.com/pine-script-reference/v6/#kw_for...in) loop statement. The first loop iterates through the “string” elements of the `newKeys` array to put key-value pairs into the map referenced by `simpleMap`, and the second iterates directly through the map’s key-value pairs to construct the custom string.
        ...
        [Previous       Conditional structures](/pine-script-docs/language/conditional-structures)  [Next   Built-ins](/pine-script-docs/language/built-ins)