...
[time series](/pine-script-docs/language/execution-model/#time-series). Time
...
[time series](/pine-script-docs/language/execution-model/#time-series) is
...
- The
[Where can I get more information](/pine-script-docs/where-can-i-get-more-information/) page lists other useful Pine Script-related content,
including where to ask questions when you are stuck on code.

We wish you a successful journey with Pine Script… and trading!

        [Previous       First indicator](/pine-script-docs/primer/first-indicator)