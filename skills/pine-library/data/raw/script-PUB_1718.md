---
id: PUB;1718
title: [RS]Price Divergence Detector V0
...
slug: script-PUB_1718
---

# Description
[RS]Price Divergence Detector V0

# Source Code
```pine
study(title='[RS]Price Divergence Detector V0', overlay=true)
//  ||  General Input:
method = input(title='Method (0=rsi, 1=macd, 2=stoch, 3=volume, 4=acc/dist):', type=integer, defval=0)
...
rsi_smooth = input(title='RSI/STOCH/Volume/ACC-DIST Smooth:', type=integer, defval=5)
//  ||  MACD Input:
